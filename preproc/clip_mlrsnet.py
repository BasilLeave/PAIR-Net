...
fp_clip = np.zeros((len(dataset['train']), args.num_class))
num_fp = 0
fn_clip = np.zeros((len(dataset['train']), args.num_class))
num_fn = 0

clip_logits_matrix = np.zeros((len(dataset['train']), args.num_class))
