...
args.image_size = 600
args.num_classes = 17
args.path_to_dataset = r'data/AID_multilabel'
...
np.save(r'data/AID_multilabel/clip_adjacency.npy', similarity.cpu().numpy())
...
np.save(r'data/AID_multilabel/clip_logits.npy', clip_logits_matrix)
