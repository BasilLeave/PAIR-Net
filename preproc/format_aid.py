...
pp.add_argument('--load-path', type=str, default=r'data/AID_multilabel', help='Path to a directory containing a copy of the AID dataset.')
pp.add_argument('--save-path', type=str, default=r'data/AID_multilabel', help='Path to output directory.')
args = pp.parse_args()

multilabel_metadata = io.loadmat(os.path.join(args.load_path, 'multilabel.mat'))
scenenames = os.listdir(r'data/AID_multilabel/images_tr')
scenenames.sort()
